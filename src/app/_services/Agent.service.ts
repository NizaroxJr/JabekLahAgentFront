...
export class AgentService {
    ...
    public saveClient(username: String, nom: String, prenom: String, numTel: String, email: String) {
        return this.http.post(
            this.agentUrl + 'client/add',
            {
                username,
                nom,
                prenom,
